...
Import example:
  ...
  use IP::RangeCompare qw(consolidate_ranges sort_ranges);
...
=item * my $obj=IP::RangeCompare->parse_new_range('10/32');

Creates a new IP::RangeCompare object.

  Examples:
  $obj=IP::RangeCompare->parse_new_range('10');
  $obj=IP::RangeCompare->parse_new_range('10.0.0.0 - 10.0.0.0');
  $obj=IP::RangeCompare->parse_new_range('10/32');
  $obj=IP::RangeCompare->parse_new_range('10/255.255.255');
  $obj=IP::RangeCompare->parse_new_range('10.0.0.0','10.0.0.0');
  ...
  Example:
    $obj=IP::RangeCompare->parse_new_range('10.0.0.0',32);
    Returns: 10.0.0.0 - 32.0.0.0

    $obj=IP::RangeCompare->parse_new_range(
      '10.0.0.0'
      ,'255.255.255.255
    );
    Returns: 10.0.0.0 - 32.0.0.0
...
=item * my $obj=IP::RangeCompare->new(0,1);
...
Simply calling the IP::RangeCompare object in a string context will return the same output as using the $obj->notation Method.
Example:

  my $obj=IP::RangeCompare->parse_new_range('10.0.0.1/255');
  print $obj,"\n";
  print $obj->notation,"\n";
...
Example:
    ...
    my $obj=IP::RangeCompare->parse_new_range(
      '10.0.0.0 - 10.0.0.4'
    );
...
=head2 IP::RangeCompare list processing functions
...
Example:
  ...
  push @$list_a, IP::RangeCompare->parse_new_range(
    '10.0.0.0 - 10.0.0.1'
    );
  push @$list_a, IP::RangeCompare->parse_new_range(
    '10.0.0.2 - 10.0.0.5'
  ...
  push @$list_b, IP::RangeCompare->parse_new_range(
    '10.0.0.0 - 10.0.0.1'
    );
  push @$list_b, IP::RangeCompare->parse_new_range(
    '10.0.0.3 - 10.0.0.4'
  ...
  push @$list_c, IP::RangeCompare->parse_new_range(
    '10.0.0.0 - 10.0.0.1'
    );
  push @$list_c, IP::RangeCompare->parse_new_range(
    '10.0.0.3 - 10.0.0.3'
...
#
# Helper package
package IP::RangeCompare::Simple;

=head1 IP::RangeCompare::Simple
...
=item * my $obj=IP::RangeCompare::Simple->new;
...
sub add_range ($$) {
  ...
  my $obj=IP::RangeCompare->parse_new_range($range);
...
Notes:
  ...
  added to the IP::RangeCompare::Simple object.
